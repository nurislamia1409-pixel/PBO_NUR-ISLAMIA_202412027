...
def tampilkan_matakuliah_semua_prodi(universitas):
    print(f"\n=== DAFTAR MATA KULIAH PER PROGRAM STUDI ({universitas.nama}) ===")
...
if __name__ == "__main__":
    ...
    # ====== b. Tambahkan minimal 2 Mata Kuliah tiap Prodi ======
    ...
    # Tambahan: tampilkan nilai mahasiswa
    print("\n=== DAFTAR NILAI MAHASISWA ===")
    for m in [m1, m2, m3]:
        nilai_list = ", ".join([f"{n.kode_mk}: {n.skor}" for n in m.daftar_nilai])
